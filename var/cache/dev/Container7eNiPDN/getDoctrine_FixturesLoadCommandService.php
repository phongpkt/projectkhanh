...
class getDoctrine_FixturesLoadCommandService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $a->addFixtures([0 => ['fixture' => new \App\DataFixtures\AppFixtures(), 'groups' => []], 1 => ['fixture' => new \App\DataFixtures\CategoryFixtures(), 'groups' => []], 2 => ['fixture' => new \App\DataFixtures\CustomerFixtures(), 'groups' => []], 3 => ['fixture' => new \App\DataFixtures\EmployeeFixtures(), 'groups' => []], 4 => ['fixture' => new \App\DataFixtures\OrderFixtures(), 'groups' => []], 5 => ['fixture' => new \App\DataFixtures\ProductFixtures(), 'groups' => []], 6 => ['fixture' => new \App\DataFixtures\UserFixtures(($container->privates['security.user_password_hasher'] ?? $container->load('getSecurity_UserPasswordHasherService'))), 'groups' => []], 7 => ['fixture' => new \App\DataFixtures\VendorFixtures(), 'groups' => []]]);
