 ...
 */
class getUserAuthenticatiorAuthenticatorService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Security\UserAuthenticatiorAuthenticator' shared autowired service.
     *
     * @return \App\Security\UserAuthenticatiorAuthenticator
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Security'.\DIRECTORY_SEPARATOR.'UserAuthenticatiorAuthenticator.php';

        return $container->privates['App\\Security\\UserAuthenticatiorAuthenticator'] = new \App\Security\UserAuthenticatiorAuthenticator(($container->services['router'] ?? $container->getRouterService()));
    }
}
